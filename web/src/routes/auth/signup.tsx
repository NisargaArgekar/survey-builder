    ...
    <div className="min-h-screen bg-white flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          ...
          <p className="text-slate-600 text-center mb-8">Sign up to start building surveys</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full px-4 py-2.5 bg-black text-white font-semibold rounded-lg hover:bg-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
          ...
          <p className="text-center mt-6 text-slate-600 text-sm">
            ...
            <a href="/auth/login" className="text-black font-semibold hover:text-slate-700">
              Sign in
            </a>
          </p>
        </div>
